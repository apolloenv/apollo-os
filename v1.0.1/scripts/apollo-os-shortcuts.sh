...
shortcuts="⌨️  APOLLO OS KEYBOARD SHORTCUTS
...
💡 TIP: Press Super (Windows key) to see more options!"

# Display in Rofi with wrapping
echo "$shortcuts" | rofi -dmenu -p "⌨️  Keyboard Shortcuts" -i \
    -theme-str 'window {width: 800px;} listview {lines: 30;}'
