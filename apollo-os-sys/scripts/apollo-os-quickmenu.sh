...
🎨 Modern - Contemporary design
 macOS - Apple macOS Sequoia style
✨ Nova - Futuristic bottom bar
🪐 Orbit - Cosmic futuristic theme
💼 Professional - Business-oriented layout
⚡ Professional Next - Ultra-futuristic monochrome
🌈 Professional Plus - Cyberpunk colorful & functional
        ...
        if [ -n "$selected_mode" ]; then
            ...
            case "$selected_mode" in
                ...
                *"Orbit"*)
                    ...
                    ;;
                *"Professional Plus"*)
                    mode="professional-plus"
                    ;;
                *"Professional Next"*)
                    mode="professional-next"
                    ;;
                *"Professional"*)
                    mode="professional"
                    ;;
