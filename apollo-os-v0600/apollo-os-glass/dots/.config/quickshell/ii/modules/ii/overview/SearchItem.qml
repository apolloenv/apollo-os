...
RippleButton {
    ...
    // Apollo OS: Use darker background for better readability when selected
    colBackground: (root.down || root.keyboardDown) ? Appearance.colors.colLayer2Active : 
        ((root.hovered || root.focus) ? Appearance.colors.colLayer2 : 
    ...
    RowLayout {
        ...
        StyledText {
            ...
            id: clickAction
            font.pixelSize: Appearance.font.pixelSize.normal
            color: Appearance.colors.colOnLayer0  // Apollo OS: White text for better readability
