# 🚀 APOLLO OS v0.6.0 - Master Documentation

**Version:** v0.6.0  
**Last Updated:** 2026-02-09  
**Status:** Production Ready  
**Platform:** Fedora Linux 43+ / Wayland / Dual Desktop (Niri Orbit + Hyprland Glass)  
...
### Sync Process:
1. Copy changes from `/home/apollo/AIQSAN01/apollo/apollo-os-dev/apollo-os-v0600/`
2. Use rsync to sync to git repo
3. Commit and push after user approval

---

## 📁 Project Structure v0600

```
/home/apollo/AIQSAN01/apollo/apollo-os-dev/apollo-os-v0600/
├── apollo-os-orbit/              # Niri Window Manager (99 files)
...
│   │   ├── configs/              # Niri theme configs (.kdl)
│   │   ├── waybar/               # Waybar themes
│   │   └── mako/                 # Notification themes
│   ├── scripts/                  # Niri-specific scripts
│   │   ├── apollo-os-visual-mode.sh
│   │   ├── toggle-*.sh           # Feature toggles
│   │   └── apollo-os-lock*.sh    # Lock screen scripts
│   └── extras/                   # Additional features
│       ├── hyprlock/             # Modern lock screen
│       ├── dock/                 # macOS-style dock configs
│       └── sounds/               # Audio feedback (.wav)
│
├── apollo-os-glass/              # Hyprland Window Manager (1105 files)
│   ├── dots/                     # Hyprland dotfiles
│   ├── dots-extra/               # Additional configs
│   └── sdata/                    # Setup data & dependencies
│
├── apollo-os-sys/                # Shared System Components (113 files)
│   ├── assets/                   # Visual resources
│   │   ├── wallpapers/           # 39 wallpapers
│   │   ├── boot/                 # Boot logos
│   │   └── spinner/              # Plymouth watermark
...
│   │   └── gtk-*.ini             # GTK themes
│   ├── scripts/                  # Utility scripts (45 scripts)
│   │   ├── apollo-wake-listener.py    # Voice wake word
│   │   ├── apollo-os-rightctrl-voice.py  # Push-to-talk
│   │   ├── apollo-speak.sh       # TTS engine
│   │   ├── voice-input*          # Whisper integration
│   │   └── apollo-os-*.sh        # System utilities
│   ├── sounds/                   # System sounds
│   │   ├── sleep.mp3             # TTS notifications
│   │   └── wake.mp3
│   └── systemd/                  # System services (10 units)
│       ├── apollo-wake.service
│       ├── apollo-rightctrl-voice.service
│       ├── apollo-os-sleep.service
│       ├── apollo-os-wake.service
│       └── systemd-sleep/        # Sleep/wake hooks
│
├── docs/                         # Documentation (54 files)
│   ├── overview.md               # Project overview
│   ├── installation-guide.md     # Installation steps
│   ├── keybindings-reference.md  # Keyboard shortcuts
│   ├── faq.md                    # Frequently asked questions
│   ├── audio-system-overview.md  # Voice control docs
│   ├── branding-guide.md         # Design guidelines
│   ├── archive/                  # Legacy documentation (43 files)
│   └── dev/                      # Developer resources (2 files)
│       ├── best-practices.md
│       └── todo.md
│
├── apollo-os-install.sh          # Main installer (2311 lines, 96 KB)
├── README.md                     # This file
├── CHANGELOG.md                  # Release notes v0.6.0
├── QUICKSTART.md                 # Quick start guide
└── LICENSE                       # MIT License

Total: 3092 files, 402 MB
```
...
- **Features:** Dual Desktop Support (Niri + Hyprland), 17 Security Modules
