...
#
# Description: Switch between 19 visual modes (Classic, Developer, Enterprise, i3 variants, Minimal, Modern, macOS, Nova, Orbit, Professional variants, SGI, Tech-Blue)
#####################################################################
...
switch_to() {
    ...
    if ! is_valid_mode "$mode"; then
        ...
        echo "Available modes: classic, developer, enterprise, i3, i3-retro, i3-contrast, minimal, modern, macos, nova, orbit, professional, professional-light, professional-next, professional-plus, sgi, tech-blue"
        return 1
    fi
...
if is_valid_mode "$1"; then
    ...
    echo "Usage: $0 [classic|developer|enterprise|i3|i3-retro|i3-contrast|minimal|modern|macos|nova|orbit|professional|professional-light|professional-next|professional-plus|sgi|tech-blue|toggle|status]"
